...
public class LinkedBinaryTree<T> implements BinaryTreeADT<T> {
    ...
    // kiểm tra xem root nut gốc có rỗng hay không nếu rỗng nem ngoai lệ  không thì trả về giá trị của root 
   ...
   //tim mot phan tu trong mot cay co tra ve true 
